...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top p-0 shadow" style="background-color: #225470;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="adminDashboard.php">BUX2.0 <small class="text-white">Admin Area</small></a> 
 </nav>
   ...
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link" href="http://localhost/test1/admin/add.php">
        <i class="fas fa-sign-out-alt"></i>
        Add quiz
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link" href="http://localhost/test1/index.php">
        <i class="fas fa-sign-out-alt"></i>
        Homepage
       </a>
      </li>
