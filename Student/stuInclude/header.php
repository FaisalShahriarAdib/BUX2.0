...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow" style="background-color: #225470;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="studentProfile.php">BUX2.0</a>
 </nav>
   ...
   <nav class="col-sm-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'quiz') {echo 'active';} ?>" href="quiz_index.php">
        <i class="fab fa-accessible-icon"></i>
        Quiz
       </a>
      </li>
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'index') {echo 'active';} ?>" href="http://localhost/test1/index.php">
        <i class="fab fa-accessible-icon"></i>
        homepage
       </a>
      </li>
