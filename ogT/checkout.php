...
session_start();
 if(!isset($_SESSION['stuLogEmail'])) {
  ...
  <div class="container mt-5">
    ...
    <h3 class="mb-5">Welcome to BUX2.0 Payment Page</h3>
    <form method="post" action="./paymentdone.php" id="myform">
      ...
      <div class="text-center">
        ...
        <a href="./paymentdone.php" class="btn btn-primary">Enroll</a>

        <a href="./courses.php" class="btn btn-secondary">Cancel</a>
      </div>
     </form>
     <small class="form-text text-muted">Note: Complete Payment by Clicking Enroll Button</small>
     </div>
    </div>
  </div>
